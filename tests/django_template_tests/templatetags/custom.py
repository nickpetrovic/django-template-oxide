...
@register.tag(name="inner_template_render")
def do_inner_template_render(parser, token):
    return _InnerTemplateRenderNode()
...
def noop(value, param=None):
    """Returns its first argument unchanged. Tests whitespace in filter
    arguments (see #19882)."""
    return value
